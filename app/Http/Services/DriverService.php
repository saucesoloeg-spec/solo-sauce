...
class DriverService
{
    ...
    {
        $sales = $this->driver_repository->getAll();  
        
        if($sales->isNotEmpty()) {
            return [
                'response_code'    => 200,
                'response_message' => 'Driver retrieved successfully.',
                'response_data'    => $sales
            ];
        }
        ...
        return [
            'response_code'    => 404,
            'response_message' => 'No drivers found.',
            'response_data'    => null
        ];
    }
    ...
    {
        $driver = $this->driver_repository->getById($id);
    ...
    public function updateSales($id, $data)
    {
        ...
        $updated = $this->driver_repository->update($id, $data);
    ...
    public function createDriver($data)
    {
        ...
        $driver  = $this->driver_repository->create($data);

        if($driver && $driver->id) {
            return [
                'response_code'    => 201,
                'response_message' => 'driver created successfully.',
                'response_data'    => $driver
            ];
        }
        ...
        return [
            'response_code'    => 400,
            'response_message' => 'Failed to create Driver !',
            'response_data'    => null
        ];
    }
