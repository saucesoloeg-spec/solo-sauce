        ...
        <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-3">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="font-weight-semibold text-lg mb-0">{{ __('drivers.create_drivers') }}</h6>
                        <p class="text-sm mb-0">{{ __('drivers.create_drivers_description') }}</p>
                    </div>
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('drivers.store') }}" method="POST">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row-fields">
                            <div class="form-group">
                                <label for="password" class="form-label">{{ __('drivers.password') }} <span style="color: red;">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="password_confirmation" class="form-label">{{ __('drivers.password_confirmation') }} <span style="color: red;">*</span></label>
                    ...
                    <div class="btn-group-action " style="justify-content: flex-end;">
                        ...
                        <button type="submit" class="btn-create">{{ __('drivers.create') }}</button>
                    </div>
                </form>
            </div>
        </div>
